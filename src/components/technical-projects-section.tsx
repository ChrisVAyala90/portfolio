    ...
    <section id="technical-projects" className="px-4 py-20 bg-background dark:bg-default-100">
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-foreground">Technical Projects</h2>
          ...
          {projectsData.projects.map((project, index) => (
            <Card key={index} className="bg-background dark:bg-default-50">
              <CardBody className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <Icon 
                      ...
                      className="text-default-600 dark:text-default-400 w-5 h-5" 
                    />
                ...
                <div className="mb-4">
                  <p className="text-sm text-foreground-600 font-medium mb-2">Key Learning:</p>
                  <p className="text-sm text-default-600">{project.keyLearning}</p>
                </div>
                
                <div className="mb-6">
                  <p className="text-sm text-foreground-600 font-medium mb-2">Tech Stack:</p>
